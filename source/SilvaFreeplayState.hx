...
class SilvaFreeplayState extends MusicBeatState
{
	var songs:Array<SongMetadatasilva> = [];
	var beatArray:Array<Int> = [154,162,165,175,200,190];
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplaySonglistsilva'));
		...
		DiscordClient.changePresence("Looking at the Secret Freeplay song list", null);
		#end
		...
		isDebug = true;
		#end
		addWeek(['Rockefeller-Street-Nightcore'], 1, ['gf']);
	...
	{
		songs.push(new SongMetadatasilva(songName, weekNum, songCharacter));
	}
