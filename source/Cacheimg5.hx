...
class Cacheimg5 extends MusicBeatState
{
	...
	override function create()
	{
		...
		var ctrl:Alphabet = new Alphabet(0, (70) + 30, "caching week five images", true, false);
			ctrl.screenCenter();
		    add(ctrl);
					...
					new FlxTimer().start(0.5, function(tmr:FlxTimer)
						{
							if(FlxG.save.data.songcache)
								{
									FlxG.switchState(new SongCacheState());
								}
								else
									{
	...
	function Cache():Void
		{
			CachedFramesimg5.loadEverything();
		}
