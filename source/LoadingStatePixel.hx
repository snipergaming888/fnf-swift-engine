...
class LoadingStatePixel extends MusicBeatState
{
	inline static var MIN_TIME = 1.0;
	
	var target:FlxState;
	var stopMusic = false;
	var callbacks:MultiCallbackPixel;
	...
	override function create()
	{
		...
		(
			function (lib)
			{
				callbacks = new MultiCallbackPixel(onLoad);
	...
	static function getNextState(target:FlxState, stopMusic = false):FlxState
	{
		...
		if (!loaded)
			return new LoadingStatePixel(target, stopMusic);
		#end
		if (stopMusic && FlxG.sound.music != null)
			FlxG.sound.music.stop();
