...
class CachedFrames
{
    ...
    public function loadFrames()
    {
        sys.thread.Thread.create(() -> {
            toBeLoaded.set('WIREStageBackPico','WIREStageBackPico');
            toBeLoaded.set('Pico_FNF_assetss_WIRE','Pico_FNF_assetss_WIRE');
            toBeLoaded.set('WIREStageBack','WIREStageBack');
            toBeLoaded.set('HEX_WIRE','HEX_WIRE');
            toBeLoaded.set('BOYFRIENDWIRE','BOYFRIENDWIRE');
