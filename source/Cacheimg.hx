...
class Cacheimg extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(0, 0 , CachedFramesimg.progress, 12);
	...
	override function update(elapsed:Float)
	{
		super.update(elapsed);
			...
			if(CachedFramesimg.loaded)
				{
					///done.visible = true;
					new FlxTimer().start(0.5, function(tmr:FlxTimer)
						{
						   FlxG.switchState(new Cacheimg2());
						});		
				}
	...
	function Cache():Void
		{
			CachedFramesimg.loadEverything();
		}
