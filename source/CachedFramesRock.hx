...
class CachedFramesRock
{
    public static var cachedInstance:CachedFramesRock;

    function new() {}

    public static function loadEverything()
    {
        cachedInstance = new CachedFramesRock();
    ...
    public function loadFrames()
    {
        sys.thread.Thread.create(() -> {
            toBeLoaded.set('bg','bg');
            toBeLoaded.set('GF_assets_glitcher','GF_assets_glitcher');
            toBeLoaded.set('BOYFRIENDGLITCHER','BOYFRIENDGLITCHER');
