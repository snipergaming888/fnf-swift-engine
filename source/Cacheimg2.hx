...
class Cacheimg2 extends MusicBeatState
{
	...
	override function create()
	{
		...
		var ctrl:Alphabet = new Alphabet(0, (70) + 30, "caching week two images", true, false);
			ctrl.screenCenter();
		    add(ctrl);
			// DONT PUT X IN THE FIRST PARAMETER OF new ALPHABET() !!
		
			
		var versionShit:FlxText = new FlxText(0, 0 , CachedFramesimg2.progress, 12);
	...
	override function update(elapsed:Float)
	{
		super.update(elapsed);
			...
			if(CachedFramesimg2.loaded)
				{
					///done.visible = true;
					new FlxTimer().start(0.5, function(tmr:FlxTimer)
						{
						   FlxG.switchState(new Cacheimg3());
						});		
				}
	...
	function Cache():Void
		{
			CachedFramesimg2.loadEverything();
		}
